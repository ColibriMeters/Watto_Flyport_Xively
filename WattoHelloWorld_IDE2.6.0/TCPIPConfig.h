...
#define MY_DEFAULT_MAC_BYTE2            (0x1E)	// 00-04-A3-00-00-00 if using
#define MY_DEFAULT_MAC_BYTE3            (0xC0)	// an ENCX24J600 or MRF24WB0M
#define MY_DEFAULT_MAC_BYTE4            (0x05)	// and wish to use the internal
#define MY_DEFAULT_MAC_BYTE5            (0x29)	// factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x5E)	// address instead.
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(7958ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_ETH_RAM, 1800, 1000},
...
{TCP_PURPOSE_FTP_COMMAND, TCP_ETH_RAM, 60, 60},
{TCP_PURPOSE_FTP_DATA, TCP_ETH_RAM, 50, 200},
